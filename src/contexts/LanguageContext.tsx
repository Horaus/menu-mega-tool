...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "featuresPage.subtitle": "Supercharge your Google Sheets™ experience with Menu Mega Tool™.",
    "featuresPage.preview.title": "Smart Link Preview",
    "featuresPage.preview.desc": "Clearly preview any links contained within a cell at a glance without opening new tabs. Our tool automatically detects URLs and provides a clear, high-resolution preview of the destination content, helping you verify information without disrupting your workflow.",
    "featuresPage.drive.title": "Google Drive™ Integration",
    "featuresPage.drive.desc": "Preview content directly from your Google Drive™ links or files shared with you, right inside your spreadsheet. Seamlessly access documents, images, and folders without ever leaving the Google Sheets™ interface, maintaining total focus on your data.",
    "featuresPage.folder.title": "Instant Folder Creation",
    "featuresPage.folder.desc": "Create a new Google Drive™ folder in just 1 second and automatically attach it to your currently selected cell. Organize your project assets instantly by generating dedicated storage spaces directly from your spreadsheet grid with a single click.",
    "featuresPage.speed.title": "300% Workflow Boost",
    "featuresPage.speed.desc": "Accelerate your data management and processing speed by up to 300% with our optimized tools. By eliminating the need to jump between tabs and manually organize files, Menu Mega Tool™ transforms how you interact with your workspace.",
    ...
    "privacyPage.intro.p2": "Menu Mega Tool™'s use and transfer of information received from Google APIs to any other app will adhere to Google API Services User Data Policy, including the Limited Use requirements.",
    ...
    "privacyPage.use.item4": "Allow viewing, instant folder creation, and renaming folders within the add-on interface",
  ...
  vi: {
    ...
    // Features Page
    "featuresPage.title": "Tính năng mạnh mẽ",
    "featuresPage.subtitle": "Nâng tầm trải nghiệm Google Sheets™ của bạn với Menu Mega Tool™.",
    "featuresPage.preview.title": "Xem trước liên kết thông minh",
    "featuresPage.preview.desc": "Xem trước nội dung của bất kỳ liên kết nào có trong ô một cách rõ ràng và nhanh chóng mà không cần chuyển tab. Công cụ của chúng tôi tự động nhận diện URL và cung cấp bản xem trước độ phân giải cao, giúp bạn xác thực thông tin mà không làm gián đoạn quy trình làm việc.",
    "featuresPage.drive.title": "Tích hợp Google Drive™",
    "featuresPage.drive.desc": "Xem trước nội dung trực tiếp từ các đường dẫn Google Drive™ của bạn hoặc được chia sẻ với bạn ngay trong trang tính. Truy cập tài liệu, hình ảnh và thư mục một cách liền mạch mà không cần rời khỏi giao diện Google Sheets™, giúp bạn duy trì sự tập trung tối đa.",
    "featuresPage.folder.title": "Tạo thư mục tức thì",
    "featuresPage.folder.desc": "Tạo thư mục Google Drive™ mới cực nhanh chỉ trong 1 giây và tự động gắn ngay vào ô hiện tại đang trỏ trong trang tính. Tổ chức tài sản dự án của bạn ngay lập tức bằng cách tạo không gian lưu trữ riêng biệt trực tiếp từ lưới trang tính chỉ với một cú nhấp chuột.",
    "featuresPage.speed.title": "Tăng tốc công việc 300%",
    "featuresPage.speed.desc": "Tăng tốc xử lý công việc và quản lý dữ liệu của bạn lên đến 300% với các công cụ tối ưu của chúng tôi. Bằng cách loại bỏ việc phải chuyển đổi giữa các tab và sắp xếp tệp thủ công, Menu Mega Tool™ thay đổi hoàn toàn cách bạn tương tác với không gian làm việc.",
    ...
    "privacyPage.intro.p2": "Việc sử dụng và chuyển thông tin nhận được từ Google API của Menu Mega Tool™ sang bất kỳ ứng dụng nào khác sẽ tuân thủ Chính sách dữ liệu người dùng của dịch vụ Google API, bao gồm các yêu cầu về Sử dụng có giới hạn.",
    ...
    "privacyPage.use.item4": "Cho phép xem, tạo nhanh thư mục và sửa đổi tên thư mục trong giao diện tiện ích",
